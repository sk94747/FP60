...
class autoShape(nn.Module):
    # input-robust mymodels wrapper for passing cv2/np/PIL/torch inputs. Includes preprocessing, inference and NMS
    ...
    def autoshape(self):
        print('autoShape already enabled, skipping... ')  # mymodels already converted to mymodels.autoshape()
        return self
